...
export default function SettingsProvider({ children }) {
	const [ settings, setSettings ] = useState({
		...
		person: {}, // личные данные пользователя: имя, дата рождения, время, город рождения, пол и фотография
		...
		moonImagesList: {} // Объект для хранения png картинок фаз луны из папки assets/images
	});
